...
const IsConnectedScreen = () => {
  ...
  return (
    <View style={{flex: 1,justifyContent:'center',alignItems:'center',}}>
        ...
        />
        <Text style={{fontSize:18,marginTop:30,fontFamily:Fonts.REGULAR,color:Colors.FONT_COLOR,marginBottom:30}}>
          ¡Ups se ha ido la conexión!</Text>
        <Button
          title={'Captación'}
          fill={true}
