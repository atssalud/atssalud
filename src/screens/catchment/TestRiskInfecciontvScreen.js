                        ...
                        </View>
                        {
                            ...
                            <View style={Styles.borderContainer}>
                                ...
                                <View>
                                    ...
                                    {
                                        (checkBox[2].item===true)?
                                        <View style={{marginBottom:15}}>
                                            <CheckBox
                                                text={criteria.options[3].name}
                                                value={checkBoxCriteria[3].item}
                                                onValueChange={(newValue) => itemCheckboxCriteriaSelected(3,criteria.options[3].name)}
                                            />
                                        </View>:null
                                    }
                                    {
                                        (checkBox[3].item===true)?
                                        <View style={{marginBottom:15}}>
                                            <CheckBox
                                                text={criteria.options[4].name}
                                                value={checkBoxCriteria[4].item}
                                                onValueChange={(newValue) => itemCheckboxCriteriaSelected(4,criteria.options[4].name)}
                                            />
                                        </View>:null
                                    }
                                    {
                                        ...
                                        <>
                                            <View style={{marginBottom:15}}>
                                                <CheckBox
                                                    text={criteria.options[5].name}
                                                    value={checkBoxCriteria[5].item}
                                                    onValueChange={(newValue) => itemCheckboxCriteriaSelected(5,criteria.options[5].name)}
                                                />
                                            </View>
                                            <View style={{marginBottom:15}}>
                                                <CheckBox
...
export default TestRiskInfecciontvScreen;
