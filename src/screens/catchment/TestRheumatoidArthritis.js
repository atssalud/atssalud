...
const TestRheumatoidArthritis = (props) => {
    ...
    const getQuestion = async () => {
        ...
        try {
            const resp = await http('get', Endpoint.listTestRheumatoidArthritis)
    ...
    const send = async () => {
        ...
        try {
            const resp = await http('post', Endpoint.sendTestRheumatoidArthritis, send)
            console.log({ resp })
            if (resp.errors) {
                setError(resp.errors)
            } else {
                navigator.replace('ViewAlertScreen', { data: resp.data, datos: datos, nameRisk: 'Tamizaje Artritis Reumatoidea' })
...
export default TestRheumatoidArthritis;
